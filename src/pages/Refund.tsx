          ...
          {[
            {
              ...
              body: 'نقدم ضمان استرداد كامل خلال ٧ أيام من تاريخ الشراء، شريطة ألا يكون الطالب قد شاهد أكثر من ٢٠٪ من محتوى الكورس. يُعدّ هذا الضمان دليلاً على ثقتنا التامة في جودة محتوانا التعليمي.'
            },
            {
              title: '٢. حالات الاسترداد المقبولة',
              body: 'يحق للطالب طلب الاسترداد في الحالات التالية: عدم قدرته على الوصول للمحتوى بسبب خلل تقني من جانب المنصة، أو إذا كان محتوى الكورس مختلفاً جوهرياً عما هو موصوف، أو في حال وجود ظروف استثنائية يتم تقييمها بشكل فردي.'
            },
            {
            ...
            },
            {
              ...
              body: 'بعد الموافقة على طلب الاسترداد، يتم إعادة المبلغ إلى وسيلة الدفع الأصلية خلال ٥-١٠ أيام عمل، وفقاً لسياسات البنك أو شركة البطاقة الائتمانية الخاصة بك.'
            },
          ].map((section, i) => (
