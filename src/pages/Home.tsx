...
const plans = [
  {
    ...
    features: [
      ...
      { text: '110 نموذج محاكاة للاختبار الحقيقي مع الشرح', ok: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '110 نموذج محاكاة للاختبار الحقيقي مع الشرح', ok: true },
      { text: 'قروب تفاعلي للدعم المستمر', ok: true },
      { text: 'بث مباشر مع الطلاب', ok: true },
      { text: 'تحليل إجاباتك بالذكاء الاصطناعي؛ لمعرفة نقاط الضعف والقوة لديك', ok: true },
    ],
...
const testimonials: Testimonial[] = [
  ...
  { kind: 'whatsapp', name: 'شهد', image: '/reviews/chat-khalid.webp' },
  { kind: 'voice', warm: false, name: 'لولو', audio: '/reviews/review-reem.mp3', time: '0:17' },
  { kind: 'voice', warm: true, name: 'نايف', audio: '/reviews/review-fahd.mp3', time: '0:21' },
]
